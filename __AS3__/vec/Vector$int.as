package __AS3__.vec
{
   ...
   [native(instance="IntVectorObject",methods="auto",cls="IntVectorClass",construct="override",gc="exact")]
   final dynamic class Vector$int
   {
      ...
      [API("708")]
      native AS3 function insertAt(param1:int, param2:int) : void;
      
      [API("708")]
      native AS3 function removeAt(param1:int) : int;
