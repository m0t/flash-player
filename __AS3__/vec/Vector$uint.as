package __AS3__.vec
{
   ...
   [native(instance="UIntVectorObject",methods="auto",cls="UIntVectorClass",construct="override",gc="exact")]
   final dynamic class Vector$uint
   {
      ...
      [API("708")]
      native AS3 function insertAt(param1:int, param2:uint) : void;
      
      [API("708")]
      native AS3 function removeAt(param1:uint) : uint;
