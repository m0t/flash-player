package __AS3__.vec
{
   ...
   [native(instance="DoubleVectorObject",methods="auto",cls="DoubleVectorClass",construct="override",gc="exact")]
   final dynamic class Vector$double
   {
      ...
      [API("708")]
      native AS3 function insertAt(param1:int, param2:Number) : void;
      
      [API("708")]
      native AS3 function removeAt(param1:int) : Number;
