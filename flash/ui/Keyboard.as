package flash.ui
{
   [native(methods="auto",cls="KeyboardClass",construct="none")]
   public final class Keyboard
   {
      ...
      native public static function get capsLock() : Boolean;
      
      native public static function get numLock() : Boolean;
      
      native public static function isAccessible() : Boolean;
      
      [API("667")]
      native public static function get hasVirtualKeyboard() : Boolean;
      
      [API("667")]
      native public static function get physicalKeyboardType() : String;
   }
}
